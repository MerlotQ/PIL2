...
// nodeIdImpl
//
#if defined(PIL_OS_FAMILY_BSD) || PIL_OS == PI_OS_QNX
//
// BSD variants
//
#include <sys/types.h>
...
#elif defined(__CYGWIN__) || PIL_OS == PI_OS_LINUX
//
// Linux, Cygwin
//
#include <sys/ioctl.h>
